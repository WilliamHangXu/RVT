...
# python eval_var.py \
#     --model-folder /home/hangxu/RVT/rvt/runs/close_box_base_10 \
...
wine_tasks=("place_wine_at_rack_location_0")
...
laptop_tasks=("close_laptop_lid_0")
...
task_list_names=("laptop_tasks")
# Optionally, if each task list requires a specific model folder, you can map them
declare -A model_folders=(
  [box_tasks]="/home/hangxu/RVT/rvt/runs/old"
  [slide_tasks]="runs/slide_block_base_15"
  [wine_tasks]="/home/hangxu/RVT/rvt/runs/place_wine_at_rack_location_base_10"
  [rope_tasks]="runs/rope_base_15"
  [scoop_tasks]="runs/scoop_base_15"
  [cups_tasks]="/home/hangxu/RVT/rvt/runs/stack_cups_base_15"
  [laptop_tasks]="/home/hangxu/RVT/rvt/runs/close_laptop_lid_base_15"
  [reach_tasks]="/home/hangxu/rvt_colosseum/rvt/runs/rvt_bs_12_NW_4_exp_id_rvt_tasks_reach_and_drag_0_E_10"
)
models=("model_9.pth")
